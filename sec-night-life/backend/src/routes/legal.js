...
router.get('/promoter-code-of-conduct', (req, res) => {
  ...
  res.json({
    ...
    effectiveDate: meta.effectiveDate,
    content: [
      { heading: 'Purpose and Scope', body: 'This Code of Conduct establishes the ethical and professional standards expected of all promoters operating on the SEC platform. Promoters play a critical role in the Platform’s ecosystem and are expected to act with integrity and professionalism.' },
      { heading: 'Accuracy and Transparency', body: 'Promoters must ensure that all information related to events, including pricing, availability, and features, is accurate and not misleading. Misrepresentation of events is strictly prohibited.' },
      { heading: 'Ethical Conduct', body: 'Promoters must conduct themselves in a manner that is respectful, lawful, and professional at all times. This includes interactions with users, Venues, and other stakeholders.' },
      { heading: 'Financial Integrity', body: 'Promoters must not engage in fraudulent practices, including ticket scams, misappropriation of funds, or unauthorized transactions outside the Platform.' },
      { heading: 'Compliance and Enforcement', body: 'SEC reserves the right to monitor promoter activity and to suspend or remove promoters who violate this Code.' },
    ],
  });
});
