...
export const MOBILE_PAGE_PARENT = {
  ...
  VendorBusinessSettings: 'Settings',
  Leaderboard: 'Home',
  Notifications: 'Home',
  HostDashboard: 'Home',
  Profile: 'Home',
  ...
  AgeVerificationDeclaration: 'Home',
  AdminDashboard: 'Home',
  ...
  RefundPolicy: 'Home',
  CookiePolicy: 'Home',
  GbvConsequences: 'Home',
  VenueComplianceCharter: 'Home',
  ...
  BusinessVenueSeatingPlans: 'BusinessDashboard',
