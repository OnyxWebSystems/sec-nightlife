...
const PERM_PAGES = {
  ...
  venue_tables: { page: 'BusinessVenueTables', label: 'Tables & day bookings', icon: BookOpen },
  seating_plans: { page: 'BusinessVenueSeatingPlans', label: 'Seating plans', icon: Building2 },
  refund_requests: { page: 'BusinessRefundRequests', label: 'Refund requests', icon: BookOpen },
