...
/**
 * Interactive guides, FAQs, and topic browse (former Help Center hub).
 * App Store Support URL stays on /HelpCenter → static support.html.
 */
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <PageBackHeader
          title="Help & Guides"
          subtitle="How-tos, FAQs, and step-by-step guides"
          pageName="HelpGuides"
        />
        ...
        <div className="px-4 py-6 max-w-xl mx-auto space-y-6">
          ...
          <p className="text-sm px-1" style={{ color: 'var(--sec-text-secondary)', lineHeight: 1.55 }}>
            Browse guides and FAQs below. Need to email us? Use{' '}
            <a href={`mailto:${SUPPORT_EMAIL}`} style={{ color: 'var(--sec-accent)' }}>
              {SUPPORT_EMAIL}
            </a>
            {' '}or open the{' '}
            <a href="/support.html" style={{ color: 'var(--sec-accent)' }}>
              Support page
            </a>
            .
          </p>
